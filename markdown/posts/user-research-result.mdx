...
- Participants unanimously feel like DCL-Metrics is a valuable service (THANK YOU!) but there is still work to be done
- There are many reasons that users visit DCL-Metrics, and each group has a specific goal in mind - removing friction for each user group to get the data they need is a priority
- The biggest issue with existing data is lack of context - we need to more explicitly explain what data we are showing in a given component and any terms so that it is crystal clear what we are displaying
- More in-depth DAO data and WORLDS data are on the most people's wishlists

### User Base and Awareness

We wanted to know the demographics of our user base and how they learned about our website.
We also wanted to know how many of them are involved in development and DAO participation.
<br />

- The majority of respondents learned about our website through Decentraland Discord and the [DAO website](https://dao.decentraland.org/).
- Respondents also mentioned social media such as Twitter/Instagram.
...
- Business/private user base are precisely 50:50 surprisingly - this is much more business related users than we were expecting.
...
- *Users* and *Map/Heatmaps* are also mentioned as useful components.
- The major learning is that we have a lot more user groups than we expected - lots of people use our site with many different goals in mind
